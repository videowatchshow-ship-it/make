<?php
/* excel-data.php — 엑셀 정산표 저장/불러오기 API (인증 필수) */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    @file_put_contents($bakdir . '/excel-' . date('Ymd-His') . '.json', $json, LOCK_EX);
...
if (is_readable($file) && filesize($file) > 0) {
    ...
    echo json_encode(['aoa' => [], 'saved_at' => null], JSON_UNESCAPED_UNICODE);
}
