...
**URL**: https://james.cent-solution.online/  
**서버 경로**: `/var/www/sites/james/`  
**서비스**: `systemd james` (또는 `site-james`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/james/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/james/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/james/login-issues` | 문제 계정 목록 |
