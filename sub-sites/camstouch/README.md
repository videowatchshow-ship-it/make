...
**URL**: https://camstouch.cent-solution.online/  
**서버 경로**: `/var/www/sites/camstouch/`  
**서비스**: `systemd camstouch` (또는 `site-camstouch`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/camstouch/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/camstouch/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/camstouch/login-issues` | 문제 계정 목록 |
