...
**URL**: https://sunbi.cent-solution.online/  
**서버 경로**: `/var/www/sites/sunbi/`  
**서비스**: `systemd sunbi` (또는 `site-sunbi`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/sunbi/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/sunbi/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/sunbi/login-issues` | 문제 계정 목록 |
