...
**URL**: https://naman.cent-solution.online/  
**서버 경로**: `/var/www/sites/naman/`  
**서비스**: `systemd naman` (또는 `site-naman`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/naman/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/naman/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/naman/login-issues` | 문제 계정 목록 |
