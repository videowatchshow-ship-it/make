...
**URL**: https://gain.cent-solution.online/  
**서버 경로**: `/var/www/sites/gain/`  
**서비스**: `systemd gain` (또는 `site-gain`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/gain/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/gain/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/gain/login-issues` | 문제 계정 목록 |
