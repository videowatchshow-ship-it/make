...
**URL**: https://soktv.cent-solution.online/  
**서버 경로**: `/var/www/sites/soktv/`  
**서비스**: `systemd soktv` (또는 `site-soktv`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/soktv/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/soktv/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/soktv/login-issues` | 문제 계정 목록 |
