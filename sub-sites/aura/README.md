...
**URL**: https://aura.cent-solution.online/  
**서버 경로**: `/var/www/sites/aura/`  
**서비스**: `systemd aura` (또는 `site-aura`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/aura/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/aura/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/aura/login-issues` | 문제 계정 목록 |
