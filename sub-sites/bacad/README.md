...
**URL**: https://bacad.cent-solution.online/  
**서버 경로**: `/var/www/sites/bacad/`  
**서비스**: `systemd bacad` (또는 `site-bacad`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/bacad/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/bacad/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/bacad/login-issues` | 문제 계정 목록 |
