...
**URL**: https://misskim.cent-solution.online/  
**서버 경로**: `/var/www/sites/misskim/`  
**서비스**: `systemd misskim` (또는 `site-misskim`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/misskim/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/misskim/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/misskim/login-issues` | 문제 계정 목록 |
