...
**URL**: https://cham.cent-solution.online/  
**서버 경로**: `/var/www/sites/cham/`  
**서비스**: `systemd cham` (또는 `site-cham`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/cham/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/cham/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/cham/login-issues` | 문제 계정 목록 |
