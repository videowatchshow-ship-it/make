...
**URL**: https://romi.cent-solution.online/  
**서버 경로**: `/var/www/sites/romi/`  
**서비스**: `systemd romi` (또는 `site-romi`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/romi/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/romi/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/romi/login-issues` | 문제 계정 목록 |
