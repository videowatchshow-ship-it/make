...
**URL**: https://win.cent-solution.online/  
**서버 경로**: `/var/www/sites/win/`  
**서비스**: `systemd win` (또는 `site-win`)  
...
| 메서드 | 경로 | 설명 |
|--------|------|------|
| GET | `/api/win/accounts` | 계정 목록 (accounts.json) |
| PATCH | `/api/win/accounts/:email/login-issue` | 로그인 문제 등록·수정·해제 |
| GET | `/api/win/login-issues` | 문제 계정 목록 |
