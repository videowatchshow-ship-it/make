...
RESTORE = [
    ...
    row("2026-07-31","23:59","마키아벨리","테더","1600","Lose","바인 $1,600 (실입금 8/1 새벽1시 · 7월 정산 귀속)"),
    row("2026-07-27","03:29","마키아벨리","캐쉬","","Lose","리바인 [이미지·금액미상] [tg:성천지]"),
]
# 8/1 새벽1시 마키아벨리 $1,600 → 7월 정산 귀속 (07-31 23:59 로 이동)
for m in ms:
    if m.get("date")=="2026-08-01" and m.get("name")=="마키아벨리" and str(m.get("deposit"))=="1600":
        m["date"] = "2026-07-31"
        m["start"] = "23:59"
        m["note"] = "바인 $1,600 (실입금 8/1 새벽1시 · 7월 정산 귀속)"
        print("  이동: 08-01 01:00 마키아벨리 $1,600 → 07-31 23:59 (7월 귀속)")
